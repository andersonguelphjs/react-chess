export class Piece  {
    ...
    set letter(letter) { this._letter = letter; }

    get isWhite() { return this._isWhite; }
    set isWhite(isWhite) { this._isWhite = isWhite;}

    get isCaptured() { return this._isCaptured; }
    set isCaptured(isCaptured) { this._isCaptured = isCaptured; }

    get numberOfTimesMoved() { return this._numberOfTimesMoved; }
    set numberOfTimesMoved(numberOfTimesMoved) { this._numberOfTimesMoved = numberOfTimesMoved; }   ;
